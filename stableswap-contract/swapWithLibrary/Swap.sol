...
contract Swap is OwnerPausable, ReentrancyGuard, Initializable, ISwap {
    using SwapLib for SwapLib.SwapStorage;
    using SafeERC20 for IERC20;
    ...
    /// STATE VARS
    SwapLib.SwapStorage public swapStorage;
    ...
    function initialize(
        ...
        for (uint256 i = 0; i < numberOfCoins; i++) {
            ...
            require(_decimals[i] <= SwapLib.POOL_TOKEN_COMMON_DECIMALS, "invalidDecimals");
            rates[i] = 10**(SwapLib.POOL_TOKEN_COMMON_DECIMALS - _decimals[i]);
        ...
        swapStorage.initialA = _A * SwapLib.A_PRECISION;
        swapStorage.futureA = _A * SwapLib.A_PRECISION;
    ...
    function rampA(uint256 futureA, uint256 futureATime) external onlyOwner {
        ...
        uint256 futureAPrecise = futureA * SwapLib.A_PRECISION;
